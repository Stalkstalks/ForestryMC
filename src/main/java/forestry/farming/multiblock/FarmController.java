...
public class FarmController extends RectangularMultiblockControllerBase
    ...
    protected void isMachineWhole() throws MultiblockValidationException {
        ...
        if (!hasGearbox) {
            throw new MultiblockValidationException(
                    StatCollector.translateToLocal("for.multiblock.farm.error.needGearbox"));
        }
    }
    ...
    public void isGoodForExteriorLevel(IMultiblockComponent part, int level) throws MultiblockValidationException {
        if (level == 2 && !(part instanceof TileFarmPlain)) {
            throw new MultiblockValidationException(
                    StatCollector.translateToLocal("for.multiblock.farm.error.needPlainBand"));
        }
    }
    ...
    public void isGoodForInterior(IMultiblockComponent part) throws MultiblockValidationException {
        if (!(part instanceof TileFarmPlain)) {
            throw new MultiblockValidationException(
                    StatCollector.translateToLocal("for.multiblock.farm.error.needPlainInterior"));
        }
    }
    ...
    public boolean plantGermling(IFarmable germling, World world, int x, int y, int z) {
        ...
        return inventory.plantGermling(germling, player, world, x, y, z);
    }
