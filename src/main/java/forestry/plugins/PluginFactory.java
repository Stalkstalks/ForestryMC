...
@Plugin(
        ...
        author = "SirSengir",
        url = Constants.URL,
        unlocalizedDescription = "for.plugin.factory.description")
public class PluginFactory extends ForestryPlugin {
    ...
    public void preInit() {
        ...
        FuelManager.bronzeEngineFuel.put(
                Fluids.BIOMASS.getFluid(),
                new EngineBronzeFuel(
                        Fluids.BIOMASS.getFluid(),
                        Constants.ENGINE_FUEL_VALUE_BIOMASS,
                        (int) (Constants.ENGINE_CYCLE_DURATION_BIOMASS
                                * ForestryAPI.activeMode.getFloatSetting("fuel.biomass.biogas")),
                        1));
        FuelManager.bronzeEngineFuel.put(
                Fluids.WATER.getFluid(),
                new EngineBronzeFuel(
                        Fluids.WATER.getFluid(),
                        Constants.ENGINE_FUEL_VALUE_WATER,
                        Constants.ENGINE_CYCLE_DURATION_WATER,
                        3));
        FuelManager.bronzeEngineFuel.put(
                Fluids.MILK.getFluid(),
                new EngineBronzeFuel(
                        Fluids.MILK.getFluid(),
                        Constants.ENGINE_FUEL_VALUE_MILK,
                        Constants.ENGINE_CYCLE_DURATION_MILK,
                        3));
        FuelManager.bronzeEngineFuel.put(
                Fluids.SEEDOIL.getFluid(),
                new EngineBronzeFuel(
                        Fluids.SEEDOIL.getFluid(),
                        Constants.ENGINE_FUEL_VALUE_SEED_OIL,
                        Constants.ENGINE_CYCLE_DURATION_SEED_OIL,
                        1));
        FuelManager.bronzeEngineFuel.put(
                Fluids.HONEY.getFluid(),
                new EngineBronzeFuel(
                        Fluids.HONEY.getFluid(),
                        Constants.ENGINE_FUEL_VALUE_HONEY,
                        Constants.ENGINE_CYCLE_DURATION_HONEY,
                        1));
        FuelManager.bronzeEngineFuel.put(
                Fluids.JUICE.getFluid(),
                new EngineBronzeFuel(
                        Fluids.JUICE.getFluid(),
                        Constants.ENGINE_FUEL_VALUE_JUICE,
                        Constants.ENGINE_CYCLE_DURATION_JUICE,
                        1));
    ...
    protected void registerRecipes() {
        ...
        RecipeManagers.fabricatorManager.addRecipe(
                ...
                electronTube.get(EnumElectronTube.ENDER, 4),
                new Object[] { " X ", "#X#", "XXX", '#', new ItemStack(Items.ender_eye, 1, 0), 'X',
        ...
        if (PluginManager.Module.APICULTURE.isEnabled()) {
            ...
            for (int i = 0; i < 16; i++) {
                RecipeManagers.fabricatorManager.addRecipe(
                        beeItems.waxCast.getWildcard(),
                        liquidGlassX4,
                        new ItemStack(Blocks.stained_glass, 4, 15 - i),
                        new Object[] { "#", "X", '#', dyes[i], 'X', beeItems.propolis.getWildcard() });
            }
            RecipeManagers.fabricatorManager.addRecipe(
                    beeItems.waxCast.getWildcard(),
                    liquidGlassX4,
                    new ItemStack(Blocks.glass, 4, 0),
                    new Object[] { "#", "X", 'X', beeItems.propolis.getWildcard() });
        }
        ...
        RecipeManagers.squeezerManager.addRecipe(
                ...
                Fluids.JUICE.getFluid(appleJuiceAmount),
                PluginCore.items.mulch.getItemStack(),
                appleMulchAmount);
        ...
        RecipeManagers.squeezerManager.addRecipe(
                10,
                new ItemStack[] { PluginCore.items.phosphor.getItemStack(2), new ItemStack(Blocks.cobblestone) },
                Fluids.LAVA.getFluid(1600));
        RecipeManagers.squeezerManager
                .addRecipe(10, new ItemStack[] { new ItemStack(Blocks.cactus) }, Fluids.WATER.getFluid(500));
        RecipeManagers.squeezerManager.addRecipe(
                10,
                new ItemStack[] { new ItemStack(Items.snowball), PluginCore.items.craftingMaterial.getIceShard(4) },
                Fluids.ICE.getFluid(4000));

        // STILL
        RecipeManagers.stillManager.addRecipe(
                Constants.STILL_DESTILLATION_DURATION,
                Fluids.BIOMASS.getFluid(Constants.STILL_DESTILLATION_INPUT),
        ...
        // MOISTENER
        RecipeManagers.moistenerManager
                .addRecipe(new ItemStack(Items.wheat_seeds), new ItemStack(Blocks.mycelium), 5000);
        RecipeManagers.moistenerManager
                .addRecipe(new ItemStack(Blocks.cobblestone), new ItemStack(Blocks.mossy_cobblestone), 20000);
        RecipeManagers.moistenerManager
                .addRecipe(new ItemStack(Blocks.stonebrick), new ItemStack(Blocks.stonebrick, 1, 1), 20000);
        ...
        RecipeManagers.fabricatorSmeltingManager
                .addSmelting(new ItemStack(Blocks.glass), Fluids.GLASS.getFluid(1000), 1000);
        RecipeManagers.fabricatorSmeltingManager
                .addSmelting(new ItemStack(Blocks.glass_pane), Fluids.GLASS.getFluid(375), 1000);
        RecipeManagers.fabricatorSmeltingManager
                .addSmelting(new ItemStack(Blocks.sand), Fluids.GLASS.getFluid(1000), 3000);
        RecipeManagers.fabricatorSmeltingManager
                .addSmelting(new ItemStack(Blocks.sand, 1, 1), Fluids.GLASS.getFluid(1000), 3000);
        RecipeManagers.fabricatorSmeltingManager
                .addSmelting(new ItemStack(Blocks.sandstone), Fluids.GLASS.getFluid(4000), 4800);
        RecipeManagers.fabricatorSmeltingManager
                .addSmelting(new ItemStack(Blocks.sandstone, 1, 1), Fluids.GLASS.getFluid(4000), 4800);
        RecipeManagers.fabricatorSmeltingManager
                .addSmelting(new ItemStack(Blocks.sandstone, 1, 2), Fluids.GLASS.getFluid(4000), 4800);

        // / CARPENTER
        RecipeManagers.carpenterManager.addRecipe(
                50,
                Fluids.SEEDOIL.getFluid(250),
                null,
                PluginCore.items.impregnatedCasing.getItemStack(),
                "###",
                "# #",
                "###",
                '#',
        ...
        RecipeManagers.carpenterManager.addRecipe(
                75,
                Fluids.WATER.getFluid(5000),
                null,
                PluginCore.items.hardenedCasing.getItemStack(),
                "# #",
                " Y ",
                "# #",
                '#',
        ...
        RecipeManagers.carpenterManager.addRecipe(
                ...
                Fluids.WATER.getFluid(1000),
                null,
                circuitBoard.get(EnumCircuitBoardType.BASIC),
                "R R",
                "R#R",
                "R R",
                '#',
        ...
        RecipeManagers.carpenterManager.addRecipe(
                ...
                Fluids.WATER.getFluid(1000),
                null,
                circuitBoard.get(EnumCircuitBoardType.ENHANCED),
                "R#R",
                "R#R",
                "R#R",
                '#',
        ...
        RecipeManagers.carpenterManager.addRecipe(
                ...
                Fluids.WATER.getFluid(1000),
                null,
                circuitBoard.get(EnumCircuitBoardType.REFINED),
                "R#R",
                "R#R",
                "R#R",
                '#',
        ...
        RecipeManagers.carpenterManager.addRecipe(
                ...
                Fluids.WATER.getFluid(1000),
                null,
                circuitBoard.get(EnumCircuitBoardType.INTRICATE),
                "R#R",
                "R#R",
                "R#R",
                '#',
        ...
        RecipeManagers.carpenterManager.addRecipe(
                ...
                Fluids.WATER.getFluid(1000),
                null,
                PluginCore.items.solderingIron.getItemStack(),
                " # ",
                "# #",
                "  B",
                '#',
        ...
        if (beeItems != null) {
            ...
            RecipeManagers.carpenterManager.addRecipe(
                    ...
                    Fluids.WATER.getFluid(1000),
                    null,
                    PluginCore.items.craftingMaterial.getDissipationCharge(),
                    "Z#Z",
                    "#Y#",
                    "X#X",
                    '#',
        ...
        RecipeManagers.carpenterManager.addRecipe(
                ...
                Fluids.WATER.getFluid(1000),
                null,
                PluginCore.items.carton.getItemStack(2),
                " # ",
                "# #",
                " # ",
                '#',
        ...
        RecipeManagers.carpenterManager.addRecipe(
                20,
                null,
                PluginCore.items.carton.getItemStack(),
        ...
        ChipsetManager.solderManager.addRecipe(
                layout,
                PluginCore.items.tubes.get(EnumElectronTube.EMERALD, 1),
                Circuit.machineSpeedUpgrade1);
        ChipsetManager.solderManager
                .addRecipe(layout, PluginCore.items.tubes.get(EnumElectronTube.BLAZE, 1), Circuit.machineSpeedUpgrade2);
        ChipsetManager.solderManager.addRecipe(
                layout,
                PluginCore.items.tubes.get(EnumElectronTube.GOLD, 1),
                Circuit.machineEfficiencyUpgrade1);

        RecipeUtil.addRecipe(
                blocks.factoryTESR.get(BlockFactoryTesrType.BOTTLER),
                "X#X",
                "#Y#",
                "X#X",
                '#',
        ...
        RecipeUtil.addRecipe(
                blocks.factoryTESR.get(BlockFactoryTesrType.CARPENTER),
                "X#X",
                "XYX",
                "X#X",
                '#',
        ...
        RecipeUtil.addRecipe(
                blocks.factoryTESR.get(BlockFactoryTesrType.CENTRIFUGE),
                "X#X",
                "XYX",
                "X#X",
                '#',
        ...
        RecipeUtil.addRecipe(
                blocks.factoryTESR.get(BlockFactoryTesrType.FERMENTER),
                "X#X",
                "#Y#",
                "X#X",
                '#',
        ...
        RecipeUtil.addRecipe(
                blocks.factoryTESR.get(BlockFactoryTesrType.MOISTENER),
                "X#X",
                "#Y#",
                "X#X",
                '#',
        ...
        RecipeUtil.addRecipe(
                blocks.factoryTESR.get(BlockFactoryTesrType.SQUEEZER),
                "X#X",
                "XYX",
                "X#X",
                '#',
        ...
        RecipeUtil.addRecipe(
                blocks.factoryTESR.get(BlockFactoryTesrType.STILL),
                "X#X",
                "#Y#",
                "X#X",
                '#',
        ...
        RecipeUtil.addRecipe(
                blocks.factoryTESR.get(BlockFactoryTesrType.RAINMAKER),
                "X#X",
                "#Y#",
                "X#X",
                '#',
                ...
                "gearTin",
                'Y',
                PluginCore.items.hardenedCasing);

        RecipeUtil.addRecipe(
                blocks.factoryPlain.get(BlockFactoryPlainType.FABRICATOR),
                "X#X",
                "#Y#",
                "XZX",
                '#',
        ...
        RecipeUtil.addRecipe(
                blocks.factoryPlain.get(BlockFactoryPlainType.RAINTANK),
                "X#X",
                "XYX",
                "X#X",
                '#',
        ...
        RecipeUtil.addRecipe(
                blocks.factoryPlain.get(BlockFactoryPlainType.WORKTABLE),
                "B",
                "W",
                "C",
                'B',
