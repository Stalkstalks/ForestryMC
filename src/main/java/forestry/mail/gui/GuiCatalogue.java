...
public class GuiCatalogue extends GuiForestry<ContainerCatalogue, IInventory> {
    ...
    private void drawTradePreview(TradeStationInfo tradeInfo, int x, int y) {
        ...
        fontRendererObj.drawString(
                String.format(StringUtil.localize("gui.mail.willtrade"), tradeInfo.owner.getName()),
                x,
                y + 18,
                fontColor.get("gui.book"));
        ...
        if (tradeInfo.state.isOk()) {
            fontRendererObj.drawSplitString(
                    EnumChatFormatting.DARK_GREEN + StringUtil.localize("chat.mail." + tradeInfo.state.getIdentifier()),
                    x,
                    y + 82,
                    119,
                    fontColor.get("gui.book"));
            ...
            fontRendererObj.drawSplitString(
                    EnumChatFormatting.DARK_RED + StringUtil.localize("chat.mail." + tradeInfo.state.getIdentifier()),
                    x,
                    y + 82,
                    119,
                    fontColor.get("gui.book"));
