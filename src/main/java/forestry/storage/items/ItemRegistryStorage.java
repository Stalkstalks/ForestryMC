...
public class ItemRegistryStorage extends ItemRegistry {
    ...
    public ItemRegistryStorage() {
        ...
        if (PluginManager.Module.LEPIDOPTEROLOGY.isEnabled()) {
            ...
            lepidopteristBackpack = new ItemBackpackNaturalist(
                    ButterflyManager.butterflyRoot,
                    definition,
                    EnumBackpackType.APIARIST);
        ...
        diggerBackpack = registerItem(
                BackpackManager.backpackInterface.addBackpack(definition, EnumBackpackType.T1),
                "diggerBag");
        diggerBackpackT2 = registerItem(
                BackpackManager.backpackInterface.addBackpack(definition, EnumBackpackType.T2),
                "diggerBagT2");

        definition = BackpackManager.definitions.get("forester");
        foresterBackpack = registerItem(
                BackpackManager.backpackInterface.addBackpack(definition, EnumBackpackType.T1),
                "foresterBag");
        foresterBackpackT2 = registerItem(
                BackpackManager.backpackInterface.addBackpack(definition, EnumBackpackType.T2),
                "foresterBagT2");

        definition = BackpackManager.definitions.get("hunter");
        hunterBackpack = registerItem(
                BackpackManager.backpackInterface.addBackpack(definition, EnumBackpackType.T1),
                "hunterBag");
        hunterBackpackT2 = registerItem(
                BackpackManager.backpackInterface.addBackpack(definition, EnumBackpackType.T2),
                "hunterBagT2");

        definition = BackpackManager.definitions.get("adventurer");
        adventurerBackpack = registerItem(
                BackpackManager.backpackInterface.addBackpack(definition, EnumBackpackType.T1),
                "adventurerBag");
        adventurerBackpackT2 = registerItem(
                BackpackManager.backpackInterface.addBackpack(definition, EnumBackpackType.T2),
                "adventurerBagT2");

        definition = BackpackManager.definitions.get("builder");
        builderBackpack = registerItem(
                BackpackManager.backpackInterface.addBackpack(definition, EnumBackpackType.T1),
                "builderBag");
